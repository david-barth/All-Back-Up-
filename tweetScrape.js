...
const subjects = ['news', 'politics', 'trending news', 'global developments', 'computers', 'technology', 'social media', 'science', 'stock market', 'investment news', "business", 'business news', "football", 'football league', 'football news', 'UEFA', 'pollution', 'environment', 'environmental news', 'climate change'];  
...
async function storeVectors(inputs, labels) {
    ...
    for (let i in inputs) {
        ...
        //Save model:
         await saveToDB(newVector, 'Vector'); 
    }
}; 
